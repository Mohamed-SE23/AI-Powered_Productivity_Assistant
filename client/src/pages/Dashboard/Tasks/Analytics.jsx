...
const Analytics = () => {
  ...
  return (
    <div className='mb-12'>
      ...
      <motion.div className='flex items-start justify-center gap-4'
            initial={{ opacity: 0, y: 50 }}
            animate={{ opacity: 1, y: 0 }}
            exit={{ opacity: 0, y: 50 }}>
        <div className='flex flex-col items-center justify-center min-w-[12rem]  p-6 w-48 h-[12.5rem] bg-white rounded shadow-md'>
        ...
        <div className='flex flex-col items-center justify-center min-w-[12rem]  p-6 w-48 h-[12.5rem] bg-white rounded shadow-md'>
          ...
          <div>
            ...
            <h3 className='text-2xl font-bold text-center text-[#333]'>{completedTasks ? completedTasks : "0"}</h3>
          </div>
        </div>
        <div className='flex flex-col items-center justify-center min-w-[12rem]  p-6 w-48 h-[12.5rem] bg-white rounded shadow-md'>
          ...
          <div>
            ...
            <h3 className='text-2xl font-bold text-center text-[#333]'>{pendingTasks ? pendingTasks : "0"}</h3>
          </div>
        </div>
        <div className='flex flex-col items-center  p-6 w-48 h-44 bg-white rounded shadow-md'>
          <RadialChart completedTasks={completedTasks} pendingTasks={pendingTasks} />
        </div>
      </motion.div>
    </div>
  )
